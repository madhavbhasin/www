...
.config(['$stateProvider', '$urlRouterProvider', '$compileProvider', function($stateProvider, $urlRouterProvider, $compileProvider) {
  ...
  $stateProvider
	...
	// VA App - Start
//Login :  by madhav bhasin
  .state('login', {
    url: '/login',
    templateUrl:  RESOURCE_ROOT + 'templates/login.html',
	...
	.state('tab.vaHome', {
      ...
      views: {
        'welfarecases-tab': {
          templateUrl: RESOURCE_ROOT + 'templates/vaHome.html',
		   controller: 'vaCheckInQRCtrl'
        }
      }
    })

	.state('tab.vaCheckInPin', {
      url: '/vaCheckInPin',
      views: {
        'welfarecases-tab': {
          templateUrl: RESOURCE_ROOT + 'templates/vaCheckInPin.html',
          controller: 'vaCheckInPinCtrl'

        }
      }
    })

	.state('tab.vaCheckInQR', {
      url: '/vaCheckInQR',
      views: {
        'welfarecases-tab': {
          templateUrl: RESOURCE_ROOT + 'templates/vaCheckInQR.html',
          controller: 'vaCheckInQRCtrl'
        }
      }
    })

	.state('tab.vaChildSelection', {
      url: '/vaChildSelection',
      views: {
        'welfarecases-tab': {
          templateUrl: RESOURCE_ROOT + 'templates/vaChildSelection.html',
          controller: 'vaChildSelectionCtrl'
        }
      }
    })

	.state('tab.vaConfirmation', {
      url: '/vaConfirmation',
      views: {
        'welfarecases-tab': {
          templateUrl: RESOURCE_ROOT + 'templates/vaConfirmation.html',
          controller: 'vaConfirmationCtrl'
        }
      }
    })
 ...
 // the account tab has its own child nav-view and history
    .state('tab.welfarecases', {
      url: '/welfarecases',
      views: {
        'welfarecases-tab': {
          templateUrl: RESOURCE_ROOT + 'templates/welfarecases.html',
		  controller: 'WelfareCasesCtrl'
        }
      }
    })
...
.state('tab.welfarecaseDetailsMenu', {
      url: '/welfarecaseDetailsMenu/:wfCaseId',
      views: {
        'welfarecases-tab': {
          templateUrl: RESOURCE_ROOT + 'templates/welfacaseDetailsMenu.html'
        }
      }
    })


.state('tab.welfarecaseDetails', {
      url: '/welfarecaseDetails/:wfCaseId',
      views: {
        'welfarecases-tab': {
          templateUrl: RESOURCE_ROOT + 'templates/welfarecaseDetails.html',
          controller: 'WelfareCaseDetailsCtrl'
...
.state('tab.welfarecaseNew', {
      url: '/welfarecaseNew',
      views: {
        'welfarecases-tab': {
          templateUrl: RESOURCE_ROOT + 'templates/welfarecaseNew.html',
          controller: 'WelfareCaseNewCtrl'
  ...
  //$urlRouterProvider.otherwise('/tab/vaHome');
